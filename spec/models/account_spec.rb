...
RSpec.describe Account, :type => :model do
  ...
  it "should require a balance" do
    expect(FactoryGirl.build(:account, balance: nil)).should_not be_valid
  end
  it "should require a user_id" do
    expect(FactoryGirl.build(:account, user_id: nil)).should_not be_valid
  end
  it "should require a name" do
    expect(FactoryGirl.build(:account, name: nil)).should_not be_valid
  end
  it "should require a name with length more than 3 letters(valid case)" do
    expect(FactoryGirl.build(:account, name: "ok")).should_not be_valid
  end
  ...
  it "should require a balance to be numerical" do
    expect(FactoryGirl.build(:account, balance: "ok")).should_not be_valid
  end
  it "should require a user_id to be numerical" do
    expect(FactoryGirl.build(:account, user_id: "ok")).should_not be_valid
  end
